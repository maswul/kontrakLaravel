<table class="table table-bordered table-striped" id="data-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><input class="form-control" type="text" name="termin_tgl_7" id="termin_tgl_7" value="{{ $termin_tgl_7 ?? '' }}"  data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" data-mask></td>
            <td><input class="form-control" type="text" name="termin_no_7" id="termin_no_7" value="{{ $termin_no_7 ?? '' }}"></td>
        </tr>
        <tr>
            <td>8</td>
            <td>BA. Pemeriksaan Administratif (Tim Administratif)</td>
            <td><input class="form-control" type="text" name="termin_tgl_8" id="termin_tgl_8" value="{{ $termin_tgl_8 ?? '' }}"  data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" data-mask></td>
            <td><input class="form-control" type="text" name="termin_no_8" id="termin_no_8" value="{{ $termin_no_8 ?? '' }}"></td>
        </tr>
        <tr>
            <td>9</td>
            <td>BA. Pembayaran</td>
            <td><input class="form-control" type="text" name="termin_tgl_9" id="termin_tgl_9" value="{{ $termin_tgl_9 ?? '' }}"  data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" data-mask></td>
            <td><input class="form-control" type="text" name="termin_no_9" id="termin_no_9" value="{{ $termin_no_9 ?? '' }}"></td>
        </tr>
