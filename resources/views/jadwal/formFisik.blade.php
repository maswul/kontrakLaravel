<table class="table table-bordered table-striped" id="data-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><input class="form-control" placeholder="WUL / 011 / X / 2020" type="text" name="termin_no_2" id="termin_no_2" value="{{ $termin->termin_no_2 ?? '' }}"></td>
        </tr>
        <tr>
            <td>3</td>
            ...
            <td><input class="form-control" placeholder="123456" type="text" name="termin_no_3" id="termin_no_3" value="{{ $termin->termin_no_3 ?? '' }}"></td>
        </tr>
        <tr>
            <td>4</td>
